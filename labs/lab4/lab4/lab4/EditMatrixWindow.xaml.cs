...
namespace lab4
{
    public partial class EditMatrixWindow : Window
    {
        ...
        private int[] privilegesUser;
        private int[] privilegesObject;
            ...
            int[] privilegesObject)
        {
            ...
            this.privilegesUser = privilegesUser;
            this.privilegesObject = privilegesObject;
        ...
        private void lstEditUsers_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            if (lstEditUsers.SelectedItem != null)
            {
                ...
                cmbUserPrivilege.SelectedIndex = privilegesUser[index];
        ...
        private void btnAddUser_Click(object sender, RoutedEventArgs e)
        {
            ...
            // Расширение массивов
            int[] newUserPriv = new int[users.Count];
            Array.Copy(privilegesUser, newUserPriv, privilegesUser.Length);
            newUserPriv[users.Count - 1] = cmbUserPrivilege.SelectedIndex;
            privilegesUser = newUserPriv;
        ...
        private void btnUpdateUser_Click(object sender, RoutedEventArgs e)
        {
            ...
            privilegesUser[index] = cmbUserPrivilege.SelectedIndex;
        ...
        private void btnDeleteUser_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (result == MessageBoxResult.Yes)
            {
                ...
                // Сжатие массива привилегий
                int[] newUserPriv = new int[users.Count];
                int newIdx = 0;
                for (int i = 0; i < privilegesUser.Length; i++)
                {
                    if (i != index)
                        newUserPriv[newIdx++] = privilegesUser[i];
                }
                privilegesUser = newUserPriv;
        ...
        private void lstEditObjects_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            if (lstEditObjects.SelectedItem != null)
            {
                ...
                cmbObjectPrivilege.SelectedIndex = privilegesObject[index];
        ...
        private void btnAddObject_Click(object sender, RoutedEventArgs e)
        {
            ...
            // Расширение массива привилегий объектов
            int[] newObjPriv = new int[objects.Count];
            Array.Copy(privilegesObject, newObjPriv, privilegesObject.Length);
            newObjPriv[objects.Count - 1] = cmbObjectPrivilege.SelectedIndex;
            privilegesObject = newObjPriv;
        ...
        private void btnUpdateObject_Click(object sender, RoutedEventArgs e)
        {
            ...
            privilegesObject[index] = cmbObjectPrivilege.SelectedIndex;
        ...
        private void btnDeleteObject_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (result == MessageBoxResult.Yes)
            {
                ...
                int[] newObjPriv = new int[objects.Count];
                int newIdx = 0;
                for (int i = 0; i < privilegesObject.Length; i++)
                {
                    if (i != index)
                        newObjPriv[newIdx++] = privilegesObject[i];
                }
                privilegesObject = newObjPriv;
